...
const youtube = YouTube("AIzaSyAdORXg7UZUo7sePv97JyoDqtQVi3Ll0b8");
...
**
        ***__General orders__***
**
『1allbots/لعرض جميع البوتات الي بالسيرفر』
『1server/يعرض لك معلومات عن السيرفر』
『1bot/يعرض لك كل معلومات البوت』
『1skin <name>/يعرض لك سكنك بماين كرافت』
『1count/يعرض لك عدد الاشخاص بالسيرفر بدون بوتات』
『1invites/ يعرض لك  عدد انفايتاتك بالسيرفر 』
『1invite-codes/يعرض لك روابط الانفايتات حكك في السيرفر 』
『1cal/اله حاسبة』
『1trans <language> <any thing>/يترجم لك الي تبيه من اي لغة』
『1short/يختصر لك رابط كبير الى رابط صغير』
『1tag/يكتب لك الكلمة بشكل جميل وكبير』
『1google/للبحث في قوقل عن طريق الدسكورد』
『1perms/يعرض لك برمشناتك بالسيرفر』
『1yn/تسأل بوت والبوت يجاوبك بنعم او لا』
『1w/امر يخليك مثل بوت تكتب عبره مع امر ويسويك بوت』
『1za5/يزخرف لك كلمة او جملة』
『1rooms/يعرض لك كل الرومات الي بالسيرفر مع عددها』
『1roles/يعرض لك كل الرانكات بالسيرفر بشكل جميل』
『1emojilist/يعرض لك كل الايموجيات الي بالسيرفر』
『1say/يكرر الكلام الي تكتبو』
『1image/صورة السيرفر』
『1members/��عرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص』
『1id/معلومات عنك』
『1profile/عرض بروفايل حقك』
『1tc/انشاء روم مؤقت ويمكنك تحديد الاعدادات』
『1bans / عدد الاشخاص المبندة 』
『1voice /  يوم لك بكتابه مجموع عدد الاشخاص الموجودين برومات』
『1avatar/صورتك او صورة الي تمنشنو』
『1embed/يكرر الي تقولو بشكل حلو』
『1discrim/كود يضهر لك الاشخاص نفس تاقك』
『1emoji <any things>/لتحويل اي كلمه تقولها الي ايموجي』
『1support/سيرفر الدعم』
『1contact/ارسال اقتراح او لمراسلة صاحب البوت』
**
  `
,`
        ***__Administrative Orders__***
**
『1move @user /  لسحب الشخص الى روومك』
『1voiceonline /  لتفعيل خاصيه فويس اونلاين يسحب عدد الاشخاص موجودين برومات』
『1bc / رسالة جماعية الى كل اعضاء السيرفر』
『1bcrole / لارسال رساله جماعي لرتبه محدده يجب تمنشنها 』
『1role @user <rank> / لأعطاء رتبة لعضو معين』
『1roleremove @user <rank> / لازالة الرتبة من شخص معين』
『1role all <rank> / لأعطاء رتبة للجميع』
『1role humans <rank> / لأعطاء رتبة للاشخاص فقط』
『1role bots <rank> / لأعطاء رتبة لجميع البوتات』
『1hchannel / اخفاء الشات』
『1schannel / اضهار الشات المخفية』
『1clr <numbr> / مسح الشات بعدد』
『1clear / مسح الشات』
『1mute @user <reason> / اعطاء العضو ميوت لازم رتبة <Muted>』
『1unmute @user / لفك الميوت عن الشخص 』
『1kick @user <reason> / طرد الشخص من السيرفر』
『1ban @user <reason> / حضر الشخص من السيرفر』
『1mutechannel / تقفيل الشات』
『1unmutechannel / فتح الشات』
『1dc / مسح كل الرومات』
『1dr / <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات』
『1ct <name> / انشاء شات』
『1cv <name> / انشاء رووم فويس』
『1delet <name> / مسح الشات او الرووم فويس』
『❖1ccolors <number> / ينشا لك الوان مع كم الوان تبي』
   `,`
        ***__Music orders__***
**
...
『1لعبة فكك / فكك』
『1عواصم عشوائي/عواصم』
『1لعبة كت تويت / كت تويت』
『1roll <number> / قرعة』
『1لو خيروك بطريقة حلوة / لو خيروك』
『1لعبة مريم / مريم』
『1فوائد ونصائح  / هل تعلم』
『1يعطيك عقابات قاسية / عقاب 』
...
/////////////////					
		...
		if (!msg.member.voiceChannel) return msg.channel.send("يجب ان تكون في روم صوتي");
        if (!serverQueue) return msg.channel.send("There is no Queue to stop1");
		...
		if (!serverQueue) return msg.channel.send('There is no Queue1');
		let index = 0;
//	//	//
...
client.on("message", async message => {
        ...
        if(message.content.startsWith('1invite-codes')) {
...
if (!message.content.startsWith(prefix)) return;
	...
	if (command == "mute") {
		if (!message.channel.guild) return;
		if(!message.guild.member(message.author).hasPermission("MANAGE_MESSAGES")) return message.reply("انت لا تملك صلاحيات 1 ").then(msg => msg.delete(5000));
...
client.on('message', message => {
    if(!message.guild) return;
    if (message.author.bot) return;
      let id = message.author.id,prefix="1";//البريفكس
